...
- **Generics across modules**: instances of a module's generic types in its public surface, its `pub` generic functions, and its `pub` functions whose compile-time parameters size arrays.
