...
| `discard`, `isNone`, `eqlOptStr`, `take` | drop a value nothing keeps (`_ = e`); test a temporary optional for `none` and drop it; compare optional strings; clear an alive flag as a value moves out |
